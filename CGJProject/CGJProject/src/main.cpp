...
void drawScene()
{
	...
	scene->Draw(Vec4(0.0f, -1.0f, 0.0f, WaterPosition.y-0.01f)); //draws everything bellow the plane
...
void setupMeshes()
{
	...
	//Water
	scene->root->CreateNode(meshLoader->Meshes[2], Transform(WaterPosition, Quat(), Vec3(2.0f, 2.0f, 2.0f)), shaders[2]);
